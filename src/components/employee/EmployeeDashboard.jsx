...
const EmployeeDashboard = () => {
    ...
    return (
        <div className=" mx-auto p-4 md:p-6 text-white min-h-screen font-sans">
            ...
            {user?.restaurantAccessLevel === 'PARTIAL' && (
                <div className="mb-6 bg-yellow-500/10 border-l-4 border-yellow-500 rounded-r-lg p-4 animate-fadeIn">
                    <div className="flex items-start gap-3">
                        <Clock className="text-yellow-500 shrink-0 mt-0.5" size={20} />
                        <div className="flex-1">
                            <p className="font-semibold text-yellow-400 mb-1">⚠️ Subscription Grace Period Active</p>
                            <p className="text-sm text-gray-300">
                                The restaurant's subscription has expired. Service will enter Read-Only mode soon.
                                Contact the restaurant owner to renew.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {user?.restaurantAccessLevel === 'READ_ONLY' && (
                <div className="mb-6 bg-orange-500/10 border-l-4 border-orange-500 rounded-r-lg p-4 animate-fadeIn">
                    <div className="flex items-start gap-3">
                        <Activity className="text-orange-500 shrink-0 mt-0.5" size={20} />
                        <div className="flex-1">
                            <p className="font-semibold text-orange-400 mb-1">🔒 Read-Only Mode Active</p>
                            <p className="text-sm text-gray-300">
                                The restaurant's subscription has expired. You can view data but cannot create or modify orders.
                                Contact the restaurant owner to restore full access.
                            </p>
                        </div>
                    </div>
                </div>
